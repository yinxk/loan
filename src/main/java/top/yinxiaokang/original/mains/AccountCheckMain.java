...
//        Date now = null;
        ...
        if (informations.isInitHasOverdue()) {
            if (isAnalyzeImported) {
                ...
                List<RepaymentItem> repaymentItemList = RepaymentPlan.listRepaymentPlan(dkyeByCsye, accountCheck.getFirstDkxffrq(informations.getCurrentPeriodRanges()), informations.getSyqs().intValue(), sthousingAccount.getDkll(),
